...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function scripts() {
			...
			wp_enqueue_style( 'plugins-style', get_template_directory_uri() . '/assets/css/plugins.css');
			wp_enqueue_style( 'main-style', get_template_directory_uri() . '/assets/css/main.css');
			wp_enqueue_style( 'font_style', get_template_directory_uri() . '/assets/fonts/icomoon/icomoon.css');
			...
			wp_enqueue_script( 'jquery-plugins', get_template_directory_uri() . '/assets/js/plugins.js', true );
			wp_enqueue_script( 'jquery-app', get_template_directory_uri() . '/assets/js/app.js', true );
