(function ($) {
 ...
 $.myParam = "someText";
	...
	var WDGTHEME = WDGTHEME || {};


	WDGTHEME.initialization = {
		init: function () {
		...
		simpleFilters: function () {
			...
			WDGTHEME.simplefilters = Object.create(SimpleFilters);
			WDGTHEME.simplefilters.init();
		},
		...
		setFullHeight: function () {
			...
			WDGTHEME.setfullheight = Object.create(SetFullHeight);
			WDGTHEME.setfullheight.init();
		},
		setFullHeightSlider: function () {
			...
			WDGTHEME.setfullheightslider = Object.create(SetFullHeightSlider);
			WDGTHEME.setfullheightslider.init();
		},
		backToTop: function (button) {
			...
			function scrollToTop() {
				...
				WDGTHEME.stickyheader.destroySticky();
			}
		...
		newsletterModal: function (modal, checkbox) {
			...
			function checkCookie() {
				if ($.cookie('wdgthemeNewsLetter') != 'yes' || $('body').hasClass('demo')) {
					openNewsletterPopup();
				}
			}
			...
			$checkBox.change(function () {
				if ($(this).is(':checked')) {
					$.cookie('wdgthemeNewsLetter', 'yes', {
						expires: parseInt($newsletter.attr('data-expires'), 10)
					});
				} else {
					$.cookie('wdgthemeNewsLetter', null, {
						path: '/'
					});
				}
			});
		...
		sliderTextTopShift: function () {
			...
			WDGTHEME.slidertexttopshift = Object.create(SliderTextTopShift).init({
				header: '.hdr',
				text: '.bnslider-text-content-flex'
			});
		},
		sideFixed: function () {
			...
			WDGTHEME.sidefixed = Object.create(SideFixed);
			WDGTHEME.sidefixed.init();
		},
		...
		flowtype: function () {
			...
			WDGTHEME.flowtype = Object.create(FlowType);
			WDGTHEME.flowtype.init('.bnr[data-fontratio]');
		},
		...
		reposInit: function () {
			...
			WDGTHEME.prdrepos1 = Object.create(ReposBlock);
			WDGTHEME.prdrepos1.init({
				desktop: '.prd-block--creative .js-prd-d-holder',
				mobile: '.prd-block--creative .js-prd-m-holder',
				reposBreakpoint: maxSM
			});
			WDGTHEME.prdrepos = Object.create(ReposBlock);
			WDGTHEME.prdrepos.init({
	...
	WDGTHEME.header = {
		...
		promoTopline: function (topline, close) {
			...
			function checkCookie() {
				if ($.cookie('wdgthemePromoTopLine') != 'yes') {
					setTimeout(function () {
						$topline.slideDown(speed, function () {
							promoToplineHeight = $topline.outerHeight();
							if (WDGTHEME.stickyheader) WDGTHEME.stickyheader.setHeaderHeight();
						});
					}, timeout);
				} else {
					$topline.slideUp(0);
			...
			$close.on('click', function () {
				if ($('body').hasClass('demo')) {
					...
					$.cookie('wdgthemePromoTopLine', 'yes', {
		...
		collapseCategory: function (btn, menu) {
			...
			$button.on('mouseenter', function (e) {
				...
				WDGTHEME.flowtype.reinit(menu + '.bnr[data-fontratio]');
				e.preventDefault();
		...
		mobileMenu: function () {
			...
			WDGTHEME.mobilemenu = Object.create(MobileMenu);
			WDGTHEME.mobilemenu.init({
				menu: '.mobilemenu'
			});
		},
		megaMenu: function () {
			...
			WDGTHEME.megamenu = Object.create(MegaMenu);
			WDGTHEME.megamenu.init({
				menu: '.mmenu-js'
			});
			WDGTHEME.vmegamenu = Object.create(MegaMenu);
			WDGTHEME.vmegamenu.init({
				menu: '.vmmenu-js',
				vertical: true
			});
		},
		mmobilePush: function () {
			...
			WDGTHEME.mobilemenupush = new mMenuPush({
		...
		headerDrop: function () {
			...
			WDGTHEME.headerdrop = new HeaderDrop();
		},
		scrollMenuInit: function (data) {
			...
			WDGTHEME.scrollmenu = new ScrollMenu(data);
		},
		miniCartInit: function (data) {
			...
			WDGTHEME.minicart = new MiniCart(data);
		},
		stickyHeaderInit: function () {
			...
			WDGTHEME.stickyheader = new StickyHeader();
		}
	}
	WDGTHEME.product = {
		init: function () {
		...
		colorToggle: function () {
			...
			WDGTHEME.colortoggle = Object.create(ColorToggle);
			WDGTHEME.colortoggle.init();
		},
		...
		quickView: function () {
			$(".js-qview-link").fancybox({
				...
				afterShow: function () {
					...
					WDGTHEME.product.simpleFancyGallery('.prd-block [data-fancybox="galleryQW"]');
				},
	...
	WDGTHEME.catalog = {
				...
				$.ajax({
					...
					success: function (data) {
						setTimeout(function () {
							...
							WDGTHEME.catalog.postAjaxCatalog();
						}, 500);
					}
				});
				e.preventDefault();
      ...
      console.log('postAjaxCatalog')
			//WDGTHEME.emptycategorydisable.reinit();
			//WDGTHEME.catalog.blockCollapse('.sidebar-block');
			//WDGTHEME.catalog.markSelectedFilter();
			//WDGTHEME.catalog.emptyBlockDisable('.prd-rating');
			WDGTHEME.colortoggle.reinit();
			WDGTHEME.initialization.productWidth('.prd, .prd-hor');
			WDGTHEME.product.selectPicker();
			WDGTHEME.product.quickView();
			WDGTHEME.initialization.imageLoaded('.prd.prd-has-loader, .prd-hor.prd-has-loader, .has-loader');
			WDGTHEME.initialization.countdown('.prd .js-countdown');
		},
		...
		emptyCategoryDisable: function () {
			...
			WDGTHEME.emptycategorydisable = Object.create(EmptyCategoryDisable);
			WDGTHEME.emptycategorydisable.init();
		},
		markSelectedFilter: function () {
			...
			WDGTHEME.markselectedfilter = Object.create(MarkSelectedFilter);
			WDGTHEME.markselectedfilter.init();
		},
		fixedSidebar: function (el) {
			...
			if ($(el).length) {
				WDGTHEME.fixedsidebar = Object.create(FixedSidebar);
				WDGTHEME.fixedsidebar.init({});
			}
		},
		...
		viewInRow: function (view) {
			...
			function allEvent(obj) {
				...
				WDGTHEME.initialization.productWidth('.prd, .prd-hor');
				WDGTHEME.product.productHeightResize('.prd');
				setTimeout(function () {
					WDGTHEME.sidefixed.reinit();
				}, 500)
			}
	...
	WDGTHEME.sections = {
		...
		productIsotopeSm: function () {
			...
			WDGTHEME.productisotopeSM = Object.create(ProductIsotopeSm);
			WDGTHEME.productisotopeSM.init({
				gallery: '.js-product-isotope-sm',
				filtersList: '.js-filters-prd-sm'
			});
		},
		productIsotope: function () {
			...
			WDGTHEME.productisotope = Object.create(ProductIsotope);
			WDGTHEME.productisotope.init({
				gallery: '.js-product-isotope'
			});
		},
		galleryIsotope: function () {
			...
			WDGTHEME.gallery = Object.create(GalleryIsotope);
			WDGTHEME.gallery.init({});
		},
		slickCarousels: function () {
			...
			$('.data-slick').each(function () {
				...
				$this.imagesLoaded(function () {
					$this.on('init', function () {
						WDGTHEME.initialization.productWidth('.prd', $this);
					})
					$this.slick({
		...
		prdCarousel: function () {
			var PrdCarousel = {
				...
				reinit: function () {
					...
					$(this.data.carousel).each(function () {
						...
						$this.on('init', function () {
							WDGTHEME.initialization.productWidth('.prd', $this);
							WDGTHEME.initialization.imageLoaded($('.prd.prd-has-loader', $this), true);
						})
						var slidesToShow = 4,
							speed = 500;
			...
			WDGTHEME.prdcarousel = Object.create(PrdCarousel);
			WDGTHEME.prdcarousel.init({});
		},
		carouselTab: function () {
			...
			WDGTHEME.carouseltab = Object.create(CarouselTab);
			WDGTHEME.carouseltab.init({});
		},
		...
		timeLine: function () {
			...
			WDGTHEME.timeline = Object.create(TimeLine);
			WDGTHEME.timeline.init({});
		}
	}
	WDGTHEME.beforeReady = {
		init: function () {
			WDGTHEME.header.mobileMenu('.mobilemenu');
		}
	};
	WDGTHEME.documentReady = {
		init: function () {
    console.log('documentReady', WDGTHEME)
    			WDGTHEME.initialization.init();
			WDGTHEME.header.init();
			WDGTHEME.sections.init();
			WDGTHEME.forms.init();
			WDGTHEME.product.init();
			WDGTHEME.catalog.init();
			// special function on ready init
			WDGTHEME.initialization.flowtype();
			WDGTHEME.header.promoTopline('.promo-topline', '.js-promo-topline-close');
			WDGTHEME.initialization.sliderTextTopShift();
			WDGTHEME.initialization.backToTop('.js-back-to-top');
			WDGTHEME.initialization.productWidth('.prd, .prd-hor');
			WDGTHEME.initialization.sideFixed();
		}
	};
	WDGTHEME.documentLoad = {
		init: function () {
			w = window.innerWidth || $window.width();
			WDGTHEME.header.stickyHeaderInit();
			if (WDGTHEME.sidefixed) WDGTHEME.sidefixed.reinit();
			WDGTHEME.initialization.scrollOnLoad();
			WDGTHEME.initialization.productWidth('.prd, .prd-hor');
			$('.slick-initialized').slick('setPosition');
			$('body').removeClass('hide-until-loaded');
		}
	};
	WDGTHEME.documentResize = {
		init: function () {
			...
			if ((window.innerWidth || $window.width()) == w) {
				if (!$body.hasClass('touch')) {
					resizeTimer = setTimeout(function () {
						...
						WDGTHEME.initialization.compensateScrollBar();
						WDGTHEME.mobilemenupush.setHeigth();
						WDGTHEME.slidertexttopshift.reinit();
						WDGTHEME.setfullheight.reinit();
						WDGTHEME.setfullheightslider.reinit();
						WDGTHEME.sidefixed.reinit();
						WDGTHEME.minicart.reinit(w);
					}, 500)
				}
			} else {
				WDGTHEME.carouseltab.hide();
				WDGTHEME.flowtype.hide('.bnr[data-fontratio]');
				WDGTHEME.product.productHeightResize('.prd');
				resizeTimer = setTimeout(function () {
					scrollWidth = calcScrollWidth();
					w = window.innerWidth || $window.width();
					isMobile = w < mobileMenuBreikpoint;
					WDGTHEME.mobilemenu.reinit();
					WDGTHEME.prdrepos1.reinit(w);
					WDGTHEME.prdrepos.reinit(w);
					WDGTHEME.initialization.compensateScrollBar();
					WDGTHEME.stickyheader.reinit(w);
					WDGTHEME.prdcarousel.reinit();
					WDGTHEME.fixedsidebar ? WDGTHEME.fixedsidebar.reinit(w) : false;
					WDGTHEME.slidertexttopshift.reinit();
					WDGTHEME.setfullheight.reinit();
					WDGTHEME.setfullheightslider.reinit();
					WDGTHEME.colortoggle.reinit();
					WDGTHEME.productisotopeSM.reinit();
					WDGTHEME.carouseltab.reinit();
					WDGTHEME.initialization.productWidth('.prd, .prd-hor');
					WDGTHEME.scrollmenu.reinit(w);
					WDGTHEME.minicart.reinit(w);
					WDGTHEME.headerdrop.reinit();
					WDGTHEME.mobilemenupush.setHeigth();
					WDGTHEME.timeline.reinit(w);
					WDGTHEME.sidefixed.reinit();
					WDGTHEME.flowtype.reinit('.bnr[data-fontratio]');
					$('.slick-initialized').slick('setPosition');
	...
	var $body = $('body'),
		...
		isMobile = w < mobileMenuBreikpoint,
		productGallery;
	WDGTHEME.beforeReady.init();
	$document.on('ready', WDGTHEME.documentReady.init);
	$window.on('load', WDGTHEME.documentLoad.init);
	$window.on('resize', WDGTHEME.documentResize.init);
  $.WDGTHEME = WDGTHEME;
})(jQuery)